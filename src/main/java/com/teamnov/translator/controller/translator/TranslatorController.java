...
public class TranslatorController {
    ...
    public Flux<Map<String, Object>> kor2Eng(@RequestParam(value = "txt", required = true) String txt) {
    ...
    public Flux<Map<String, Object>> eng2Kor(@RequestParam(value = "txt", required = true) String txt) {
